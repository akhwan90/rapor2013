...
class Login extends CI_Controller {
    ...
    public function do_login() {
        ...
        if($j_cek == 1) {
            ...
            if ($level == "guru") {
                $cek_is_wali_kelas = $this->db->query("SELECT a.id_kelas, b.nama nmkelas FROM t_walikelas a INNER JOIN m_kelas b ON a.id_kelas = b.id WHERE a.tasm = '".$this->d['tasm']."' AND a.id_guru = '".$d_cek->konid."'")->row_array();
