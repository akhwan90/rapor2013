...
class Cetak_raport extends CI_Controller {
    function __construct() {
        ...
        $this->d['kepsek'] = $get_tasm['nama_kepsek'];
        $this->d['nip_kepsek'] = $get_tasm['nip_kepsek'];
        $this->d['tgl_raport'] = $get_tasm['tgl_raport'];
    ...
    public function cetak($id_siswa,$tasm) {
        ...
        $siswa = $this->db->query("SELECT 
                                    a.nama, a.nis, a.nisn, c.tingkat
                                    FROM m_siswa a
                                    LEFT JOIN t_kelas_siswa b ON a.id = b.id_siswa
                                    LEFT JOIN m_kelas c ON b.id_kelas = c.id
                                    WHERE a.id = $id_siswa")->row_array();
        
        $d['nama_kelas'] = $this->d['wk']['nama_walikelas'];
