...
<body>
	<table>
		...
		<tr>
			<td width="20%">Nama Madrasah</td><td width="1%">:</td><td width="39%" class="tbl">MTs N 5 Kulon Progo</td>
			<td width="20%">Kelas</td><td width="1%">:</td><td width="19%" class="tbl"><?php echo strtoupper($nama_kelas); ?></td>
		</tr>
		<tr>
				...
				<table width="100%">
					<tr>
						...
						<td width="25%">
							...
							Wali Kelas <br>
							<br><br><br><br>
							<u><b><?php echo $wk['app_rapot_nama']; ?></b></u><br>
							NIP. <?php echo $wk['app_rapot_nip']; ?>
						</td>
						<td width="8%"></td>
						<td width="29%">
							Sidoharjo, <?php echo tjs($tgl_raport,'s'); ?><br>
							Kepala <?php echo $this->config->item('nama_sekolah'); ?> <br>
							<br><br><br><br>
							<u><b><?php echo $kepsek; ?>/b></u><br>
