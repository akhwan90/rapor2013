                                ...
                                if (!empty($list_kd)) {
                                    foreach ($list_kd as $k) {
                                        if (in_array($k['id'], $pc_selalu)) {
                                            echo '<td class="ctr"><label class="nso"><input type="checkbox" name="selalu_'.$no.'[]" value="'.$k['id'].'" checked></label></td>';                                            
                                        } else {
                                            echo '<td class="ctr"><label class="nso"><input type="checkbox" name="selalu_'.$no.'[]" value="'.$k['id'].'"></label></td>';
                                        }
