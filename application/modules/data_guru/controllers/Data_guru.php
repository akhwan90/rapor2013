...
class Data_guru extends CI_Controller {
    ...
    public function datatable() {
        ...
        foreach ($q_datanya as $d) {
            ...
            $data_ok[0] = $no++;
            $data_ok[1] = $d['nip'];
            $data_ok[2] = $d['nama']." / <b><i>".$d['username']."</i></b>";
    ...
    public function aktifkan($id) {
        ...
        if (empty($detil_data)) {
            ...
            $this->db->query("INSERT INTO m_admin (username,password,level,konid,aktif) VALUES ('".substr($username, 0, 6)."', '".$password."', 'guru', '$id', 'Y')");

            $d['status'] = "ok";
            $d['data'] = "Username : ".substr($username, 0, 6)." berhasil diaktifkan..! Password default guru123";
        }
