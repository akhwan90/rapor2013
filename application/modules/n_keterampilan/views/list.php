        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <ul class="list-group" id="list_kd">
                    ...
                    ?>
                    <li class="list-group-item"><a href="#" onclick="return view_kd(<?php echo $lk['id'].", ".$detil_mp['id_kelas']; ?>);"><i class="fa fa-chevron-right"></i>  <?php echo "(".$lk['no_kd'].") ".$lk['nama_kd'].""; ?></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" id="tbSimpan">Simpan</button>
    ...
    function view_kd(id, kelas) {
        ...
        if (id == 0 && kelas == 0) {
            ...
            $.getJSON(base_url+"<?php echo $url; ?>/ambil_siswa/"+kelas+"/"+id, function(data) {
                ...
                html = '<table class="table table-condensed"><thead><tr><th width="10%">No</th><th width="70%">Nama</th><th width="20%">Nilai</th></tr></thead><tbody>';
                var i = 1;
                ...
                html += '</tbody></table><p><button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Simpan</button></p>';
